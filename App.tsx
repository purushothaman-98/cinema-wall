...
// 2. DETAIL PAGE (Simplified for brevity, same logic applies)
    ...
    try {
        ...
        if (res.ok) {
            ...
            setAiSummary({
                ...
                summary: "Critics generally praise the visual fidelity and acting performances."
            });
        }
    } catch (e) {
        console.error(e);
        ...
        <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 space-y-8">
                ...
                <div className="bg-gradient-to-br from-slate-900 to-slate-800 border border-primary/30 p-6 rounded-xl relative overflow-hidden">
                    <h2 className="text-xl font-bold text-primary mb-4">AI Consensus Protocol</h2>
                    {!aiSummary ? (
                        <div className="text-center py-8">
                            <button onClick={generateConsensus} disabled={generating} className="bg-primary hover:bg-yellow-400 text-black font-bold py-2 px-6 rounded transition-all">
                        ...
                        <div>
                            ...
                            <p className="text-gray-300 mb-6">{aiSummary.summary}</p>
                            <button onClick={saveToVault} className="text-xs text-primary">Save to Vault</button>
                        </div>
                    )}
                </div>
                <div>
